...
function sign(msg, secretKey) {
    ...
    const signedMsg = (0, array_js_1.ByteArray)(64 /* Signature */ + msg.length);
...
function sign_detached(msg, secretKey) {
    ...
    const sig = (0, array_js_1.ByteArray)(64 /* Signature */);
...
function sign_detached_verify(msg, sig, publicKey) {
    ...
    if (publicKey.length !== 32 /* PublicKey */)
        throw new Error('bad public key size');
    const sm = (0, array_js_1.ByteArray)(64 /* Signature */ + msg.length);
    const m = (0, array_js_1.ByteArray)(64 /* Signature */ + msg.length);
    let i;
...
function sign_keyPair() {
    const pk = (0, array_js_1.ByteArray)(32 /* PublicKey */);
    const sk = (0, array_js_1.ByteArray)(64 /* SecretKey */);
