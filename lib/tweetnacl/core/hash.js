...
function hash(msg) {
    (0, array_js_1.checkArrayTypes)(msg);
    const h = (0, array_js_1.ByteArray)(64 /* HashLength.Hash */);
    _hash(h, msg, msg.length);
    return h;
}
exports.hash = hash;
function _hash(out, m, n) {
    const hh = (0, array_js_1.IntArray)(8), hl = (0, array_js_1.IntArray)(8), x = (0, array_js_1.ByteArray)(256);
    let i, b = n;
    hh[0] = 0x6a09e667;
    hh[1] = 0xbb67ae85;
    hh[2] = 0x3c6ef372;
...
function _hashblocks_hl(hh, hl, m, n) {
    const wh = (0, array_js_1.IntArray)(16), wl = (0, array_js_1.IntArray)(16);
