...
function pack25519(o, n) {
    const m = core_js_1.gf(), t = core_js_1.gf();
    let i, j, b;
    for (i = 0; i < 16; i++)
        t[i] = n[i];
    car25519(t);
...
function neq25519(a, b) {
    const c = array_js_1.ByteArray(32), d = array_js_1.ByteArray(32);
    pack25519(c, a);
    pack25519(d, b);
    return verify_js_1._verify_32(c, 0, d, 0);
}
exports.neq25519 = neq25519;
function par25519(a) {
    const d = array_js_1.ByteArray(32);
    pack25519(d, a);
    return d[0] & 1;
}
