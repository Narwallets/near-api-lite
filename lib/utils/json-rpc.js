...
exports.jsonRpcQuery = exports.jsonRpc = exports.jsonRpcInternal = exports.formatJSONErr = exports.getHeaders = exports.addHeader = exports.setRpcUrl = void 0;
    ...
    if (largeNumbersFound) {
        for (const matches of largeNumbersFound) {
            ...
            if (yoctoString.length >= 20) {
                // convert to NEAR
                text = text.replace(new RegExp(yoctoString, "g"), conversion_js_1.ytonFull(yoctoString));
            }
        }
    }
...
async function jsonRpcInternal(payload) {
    try {
        ...
        while (true) {
            let fetchResult = await node_fetch_1.default(rpcUrl, rpcOptions);
