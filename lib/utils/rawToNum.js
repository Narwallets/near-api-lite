...
exports.addCommas = exports.stringWithDecPoint = exports.rawToNum = void 0;
/**
 ...
 */
function rawToNum(rawAmount, decimals) {
    return Number(stringWithDecPoint(rawAmount, decimals));
}
exports.rawToNum = rawToNum;
/**
 ...
 */
function stringWithDecPoint(rawAmount, decimals) {
    let rawAmountAsString = rawAmount.toString();
    if (rawAmountAsString.indexOf(".") !== -1)
        throw new Error("a raw amount can't have a decimal point: " + rawAmountAsString);
    let sign = "";
...
exports.stringWithDecPoint = stringWithDecPoint;
/**
